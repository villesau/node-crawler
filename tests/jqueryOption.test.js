...
describe('Jquery testing', function () {
  ...
  describe('Jquery injection', function () {
    ...
    given
      .async(jsdom)
      .it('should enable jsdom if set', function (done, jquery) {
        c = new Crawler({
          jquery: jquery,
          callback: function (error, res) {
            expect(error).to.be.null;
    ...
    given
      ...
      .it('should enable cheerio if set', function (done, jquery) {
        c = new Crawler({
          jquery: jquery,
          callback: function (error, res) {
            expect(error).to.be.null;
    ...
    given
      .async('trucmuch', null, undefined)
      .it('should not inject jquery', function (done, jquery) {
        c = new Crawler({
          jquery: jquery,
          callback: function (error, res) {
            expect(error).to.be.null;
    ...
    given
      .async('cheerio', jsdom)
      .it(
        'should also enable jQuery even if body is empty, to prevent `$ is not a function` error',
    ...
    given
      .async('cheerio', jsdom)
      .it('should disable jQuery if body is not text/html ', function (
        done,
        jquery
      ) {
        c = new Crawler({
